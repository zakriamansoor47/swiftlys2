...
internal partial class FeBuildSphereRigid_tImpl : FeSphereRigid_tImpl, FeBuildSphereRigid_t
{
    ...
    public ref int Priority {
        get {
            _PriorityOffset = _PriorityOffset ?? Schema.GetOffset(0xB0A01B13E7EFB335);
    ...
    public ref uint VertexMapHash {
        get {
            _VertexMapHashOffset = _VertexMapHashOffset ?? Schema.GetOffset(0xB0A01B1306BCA0A3);
    ...
    public ref uint AntitunnelGroupBits {
        get {
            _AntitunnelGroupBitsOffset = _AntitunnelGroupBitsOffset ?? Schema.GetOffset(0xB0A01B13A5C6E91A);
