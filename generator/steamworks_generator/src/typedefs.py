...
def main(parser):
    ...
    for root, directories, filenames in os.walk('templates/custom_types/'):
        for filename in filenames:
            outputdir = "../../managed/src/SwiftlyS2.Generated/SteamAPI/Types/" + root[len('templates/custom_types/'):]
            try:
...
""", "", 1)
        ...
        try:
            os.makedirs("../../managed/src/SwiftlyS2.Generated/SteamAPI/Types/" + foldername)
        except OSError:
            pass

        with open("../../managed/src/SwiftlyS2.Generated/SteamAPI/Types/" + foldername + "/" + t.name + ".cs", "wb") as out:
            out.write(bytes(HEADER, "utf-8"))
