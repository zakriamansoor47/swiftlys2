...
def main(parser):
    ...
    with open("../../managed/src/SwiftlyS2.Generated/SteamAPI/SteamStructs.cs", "wb") as out:
    ...
    with open("../../managed/src/SwiftlyS2.Generated/SteamAPI/SteamCallbacks.cs", "wb") as out:
        with open("templates/header.txt", "r") as f:
            out.write(bytes(f.read(), "utf-8"))
        out.write(bytes("namespace SwiftlyS2.Shared.SteamAPI {\n", "utf-8"))
